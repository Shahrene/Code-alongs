...
var generateRandomCombo = function(arr) {
...
var combos = []
for (var i = 0; i < 5; i++) {
  var first = generateRandomCombo(thisArray)
  var second = generateRandomCombo(thatArray)
  var result = first + ' for ' + second
  combos.push(result)
}

for (var i = 1; i < 6; i++) {
  console.log(i + " : " + combos[i-1])
}
